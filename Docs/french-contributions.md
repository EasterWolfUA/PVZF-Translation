# 🇫🇷 Pôle francophone — Contributeurs

Ce projet de traduction repose sur un travail collectif structuré, mené par une communauté francophone investie dans la qualité linguistique, la cohérence terminologique et le respect de l’œuvre originale.

Ce document a pour objectif de reconnaître et valoriser les personnes impliquées dans le pôle francophone, quels que soient l’ampleur ou la durée de leur contribution.


---

## Lead du Pôle Francophone
**[Charles LINDECKER](./french-contributor/lindecker-charles.md)**

* Coordination des contributeurs
* Responsable des recrutements
* Développement d'outil pour faciliter la review
* Suivi qualité et validation des traductions
...
## Rejoindre le pôle francophone

Le pôle francophone est ouvert aux traducteurs, relecteurs et passionnés de localisation souhaitant s’impliquer dans un cadre collaboratif et structuré.

Les échanges, le suivi des tâches et les validations s’effectuent principalement via Trello et GitHub.
