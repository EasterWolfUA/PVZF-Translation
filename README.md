...
**Multi-Language 3.2.1 Version 1** | PC | [Github Release](https://github.com/Teyliu/PVZF-Translation/releases/tag/3.2.1_v1)
**English 3.0.1 Version 2** | Android | [Github Release](https://github.com/Teyliu/PVZF-Translation/releases/tag/3.0.1_android_v2)
**Chinese 3.3.0-P1** | PC | [MEGA](https://mega.nz/file/qZwXSIZZ#NJzj2EouGBlczx_YSBFFHijzf3MB7imvZnQj8uOQdFc) [Google Drive](https://drive.google.com/file/d/1QjLxRJ18e1BIKlQKxo0rfyYTuxri9oyW/view?usp=sharing)
**Chinese 3.3.0-P1** | Android | [MEGA](https://mega.nz/file/2dRxhYiS#U2UhOR7bf6JZ_JfjP89BjMdO3eGnvS5liG8dMrBc55k) [Google Drive](https://drive.google.com/file/d/1-OeP4lYi7LwMOBqh8tj1nI4OnBchZ-AI/view?usp=sharing)
...
The Multi-Language version supports the following languages: **English**, **French**, **Italian**, **German**, **Spanish**, **Portuguese**, **Vietnamese**, **Javanese**, **Indonesian**, **Russian**, **Japanese**, **Ukrainian** and **Korean**. Other contained languages are empty for the moment.
	...
	Up-to-date (3.2.1) - English, Vietnamese, Spanish, Korean, Ukrainian
	Gradually updating to 3.2.1 - French, Japanese
...
![The Online English Almanac](https://i.imgur.com/5xipoXB.png)
